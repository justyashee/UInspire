...
const DashboardPage = () => {
  ...
  useEffect(() => {
    setLoading(true);
    axios.get(`${process.env.NEXT_PUBLIC_API_URL}/project/getbyuser`, {
      headers: {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#050505] via-[#0a0a1a] to-[#0f001f] text-white font-sans flex flex-col">
      <Header />

      {/* ✅ flex-1 wraps all content so footer sticks to bottom */}
      <div className="flex-1 px-6 pt-32 pb-10">
        ...
        {loading && (
          <div className="text-center text-purple-400 animate-pulse">Loading projects...</div>
        )}
        {error && (
