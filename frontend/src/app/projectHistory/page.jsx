...
const DashboardPage = () => {
  ...
  useEffect(() => {
    axios.get('http://localhost:5000/project/getbyuser', {
      headers: {
  ...
  return (
    ...
    //             className="p-8 rounded-2xl bg-gradient-to-br from-[#0f0f1f] to-[#121232] border border-purple-800 shadow-[0_0_30px_rgba(168,85,247,0.25)] hover:shadow-[0_0_45px_rgba(168,85,247,0.6)] transition-all"
    //           >
    //             <h3 className="text-2xl font-semibold text-purple-300 mb-3">{project.prompt || 'Untitled Project'}</h3>
    ...
    //         ))
    //       ) : (
    //         <div className="col-span-full text-center text-gray-500">No projects found. Try creating one!</div>
    //       )}
    //       {/* New Project Card */}
    //       <div
